      ...
      >
        <div className="card shadow-sm p-4" style={{ maxWidth: "400px", width: "100%" }}>
          ...
          <div className="text-center mt-4">
            <Link
              href="/"
              className="text-decoration-none d-flex align-items-center justify-content-center small gap-2 text-secondary"
            >
      ...
      <div className="row">
        <div className="col-md-3">
          <div className="shadow-sm border-0 list-group mb-4">
            <div className="list-group-item small fw-bold text-uppercase text-mute py-2">
              Správa obchodu
            </div>
            <button
            ...
            <div className="list-group-item small fw-bold text-uppercase text-mute py-2 mt-3">
              Organizace a Provoz
            </div>
            <button
