...
export default function DBSettings() {
  ...
  const handleAction = async (action: 'create' | 'verify' | 'wipe' | 'seed') => {
    if (action === 'wipe' && !confirm('Opravdu chcete smazat všechna data z databáze? Tato akce je nevratná.')) {
      return;
    }
  ...
  return (
    <div className="card h-100">
      <div className="card-header"><h5 className="mb-0">Správa Databáze</h5></div>
      <div className="card-body">
        ...
        <div className="mb-4">
          ...
          <div className="input-group">
            <span className="input-group-text"><Fa.FaFolderOpen /></span>
            <input 
              type="text" 
